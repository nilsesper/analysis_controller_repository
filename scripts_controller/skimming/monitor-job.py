...
if SkimmingParamsSubmission.submission_type == "aachen-condor":
    ...
    if action_type == "monitor":
        ...
        condor_workarea = SkimmingSubmission.condor_workarea
        condor_cluster_id = SkimmingSubmission.condor_cluster_id
...
#======
    ...
    console_utils.raise_exception(string=f"Unsupported submission type \"{SkimmingSubmission.submission_type}\"")
#=============================================================================
